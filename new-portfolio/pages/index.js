			...
			<main className="bg-gray-200 px-10">
				<section className="min-h-screen">
					...
					<div className="text-center p-10 m-7 mb-54 ml-40">
						...
						<div className="relative mx-auto bg-gradient-to-b from-fuchsia-800 rounded-full w-80 h-80 mt-20 overflow-hidden mt-5 ml-50 mr-40">
							...
							<div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
								...
								<div class="rounded overflow-hidden shadow-lg duration-200 ease-in-out transform hover:scale-110">
									...
									<div class="px-6 py-4">
										...
										<p class="text-gray-700 text-base">
											An app, built using the TMDB api where you can access all
											the latest trending movies daily or weekly! The app is
											designed to be user-friendly, making the experience for
											the user transparent and enduring.
										</p>
									</div>
									<div class="px-6 pt-4 pb-2">
										<span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
